...
modules = CMD_HELP
alive_logo = (
    gvarstatus("ALIVE_LOGO") or "https://te.legra.ph/file/74d210f7ebc9e05437fbc.jpg"
)
...
async def alive(client: Client, message: Message):
    ...
    man = (
        f"**[ꜱᴜᴍɪᴛ x ᴜʙ](https://github.com/mrismanaziz/PyroMan-Userbot) is Up and Running.**\n\n"
        f"<b>{alive_text}</b>\n\n"
        ...
        f"    **[𝗦𝘂𝗽𝗽𝗼𝗿𝘁](https://t.me/twinkle_starz)** | **[𝗖𝗵𝗮𝗻𝗻𝗲𝗹](https://t.me/ab_sumit)** | **[𝗢𝘄𝗻𝗲𝗿](tg://user?id={client.me.id})**"
    )
    try:
